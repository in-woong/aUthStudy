...
const Nav = () => {
  ...
  return (
    <section className='navbar fixed w-full text-neutral-content shadow-md'>
      <div className='flex w-full'>
        ...
        <h1 className='shrink-0 flex flex-1 mx-1'>
          <Link to={'/'}>
            <img className='w-36' src='./mainTheme.png' alt='icon' />
          </Link>
        </h1>
      </div>
